...
public class ReactionService {
    ...
    public ReactionResponse addReaction(UUID channelId, UUID messageId, AddReactionRequest req) {
        ...
        validateMessageExists(tenantId, messageId);
        ...
        fanoutReactionEvent(tenantId, channelId, messageId, userId, req.getEmoji(), true);
    ...
    public void removeReaction(UUID channelId, UUID messageId, String emoji) {
        ...
        fanoutReactionEvent(tenantId, channelId, messageId, userId, emoji, false);
    ...
    private void validateMessageExists(UUID tenantId, UUID messageId) {
    ...
    private void fanoutReactionEvent(UUID tenantId, UUID channelId, UUID messageId,
                                      UUID userId, String emoji, boolean added) {
        try {
            String payload = added
                    ? WsPayloadBuilder.buildReactionAdded(tenantId, channelId, messageId, userId, emoji, objectMapper)
                    : WsPayloadBuilder.buildReactionRemoved(tenantId, channelId, messageId, userId, emoji, objectMapper);
